...
<ul>
<li>Name: <input type="text" name="name" value="<?=$arrayUser[1]?>"/></li>
<li>E-mail: <input type="text" name="email" value="<?=$arrayUser[2]?>"/></li>
<li>Password: <input type="password" name="pass"/></li>
<li>Description: <textarea rows="4" cols="50" name="desc"><?=$arrayUser[4]?></textarea></li>
